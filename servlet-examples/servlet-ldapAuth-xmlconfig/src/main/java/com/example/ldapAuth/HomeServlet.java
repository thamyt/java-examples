...
public class HomeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("isCashier", request.isUserInRole("cashier"));
		request.setAttribute("isSupervisor", request.isUserInRole("supervisor"));
		request.setAttribute("isManager", request.isUserInRole("manager"));
		request.setAttribute("isDirector", request.isUserInRole("director"));
