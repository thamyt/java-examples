package com.example.mvc_multiservlets_javaconfig.controller.thymeleaf;
...
public class ThymeLeafDemoController extends BaseController {
	...
	public String home(Model model) {
		System.out.println("Inside ThymeLeafDemoController home()");
		return "demo.html";
	}
	
	@RequestMapping(value="/loop", method = RequestMethod.GET)
	public String loop(Model model) {
		System.out.println("Inside ThymeLeafDemoController loop()");
