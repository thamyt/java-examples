package com.example.mvc_multiservlets_javaconfig.controller.freemarker;
...
public class FreemarkerDemoController extends BaseController {
	...
	public String home(Model model) {
		System.out.println("Inside FreemarkerDemoController home()");
		return "demo";
	}
	
	@RequestMapping(value="/loop", method = RequestMethod.GET)
	public String loop(Model model) {
		System.out.println("Inside FreemarkerDemoController loop()");
