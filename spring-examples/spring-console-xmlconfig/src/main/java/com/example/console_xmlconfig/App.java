...
import com.example.console_xmlconfig.beans.GreetingPrototypeBean;
import com.example.console_xmlconfig.beans.GreetingSingletonBean;
...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	System.out.println("Test Spring Bean declared in XML");
    	System.out.println("--------------------------------------");
